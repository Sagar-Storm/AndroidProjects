...
public class RunDataBaseHelper extends SQLiteOpenHelper {
    ...
    public RunCursor queryRun(long id) {
        Cursor wrapper = getReadableDatabase().query(TABLE_RUN, null, COLUMN_RUN_ID + " =  ?" + new String[]{String.valueOf(id)}, null, null, null, null);
        if(wrapper != null) {
            wrapper.moveToFirst();
        }
        //Cursor w = null;
    ...
    public LocationCursor queryLastKnownLocationForRun(long id) {
        Location location = null;
        Cursor wrapper = getReadableDatabase().query(TABLE_LOCATION, null, COLUMN_LOCATION_RUN_ID + " = ?" + new String[] {String.valueOf(id)}, null, null, COLUMN_LOCATION_TIMESTAMP + " desc", "1");
    ...
    public LocationCursor queryLocationsForRun(long runId) {
        Cursor wrapped = getReadableDatabase().query(TABLE_LOCATION,, null,
                ...
                new String[]{ String.valueOf(runId)}.clone(),
                null,
                null,
